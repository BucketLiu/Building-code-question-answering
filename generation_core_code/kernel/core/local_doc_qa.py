...
from kernel.configs.model_config import VECTOR_SEARCH_TOP_K, CHUNK_SIZE, VECTOR_SEARCH_SCORE_THRESHOLD, \
    PROMPT_TEMPLATE, STREAMING, OCR_MODEL_PATH
from typing import List
import time
from kernel.connector.llm.llm_for_openai_api import OpenAILLM
from langchain.schema import Document
from kernel.connector.database.mysql.mysql_client import KnowledgeBaseManager
from kernel.connector.database.faiss.faiss_client import FaissClient
from kernel.connector.rerank.rerank_backend import RerankBackend
from kernel.connector.embedding.embedding_backend import EmbeddingBackend
from kernel.utils.custom_log import debug_logger, qa_logger
from kernel.core.tools.web_search_tool import duckduckgo_search
from kernel.dependent_server.ocr_server.ocr import OCRthing
from kernel.utils.general_utils import num_tokens, get_time
    ...
    def init_cfg(self, args=None):
        ...
        if platform.system() == 'Linux':
            if args.use_openai_api:
                ...
                from kernel.connector.llm.llm_for_fastchat import OpenAICustomLLM
                self.llm: OpenAICustomLLM = OpenAICustomLLM(args)
            from kernel.connector.rerank.rerank_onnx_backend import RerankOnnxBackend
            from kernel.connector.embedding.embedding_onnx_backend import EmbeddingOnnxBackend
            ...
            if args.use_openai_api:
                ...
                from kernel.connector.llm.llm_for_llamacpp import LlamaCPPCustomLLM
                self.llm: LlamaCPPCustomLLM = LlamaCPPCustomLLM(args)
            from kernel.connector.rerank.rerank_torch_backend import RerankTorchBackend
            from kernel.connector.embedding.embedding_torch_backend import EmbeddingTorchBackend
        ...
        self.ocr_reader = OCRthing(model_dir=OCR_MODEL_PATH, device="cpu")  # 省显存

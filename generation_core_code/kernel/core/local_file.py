from kernel.utils.general_utils import *
from typing import List, Union, Callable
from kernel.configs.model_config import UPLOAD_ROOT_PATH, SENTENCE_SIZE, ZH_TITLE_ENHANCE, USE_FAST_PDF_PARSER, PDF_MODEL_PATH
from langchain.docstore.document import Document
from kernel.utils.loader.my_recursive_url_loader import MyRecursiveUrlLoader
...
from kernel.utils.loader.csv_loader import CSVLoader
from langchain.text_splitter import RecursiveCharacterTextSplitter
from kernel.utils.custom_log import debug_logger, qa_logger
from kernel.utils.splitter import ChineseTextSplitter
from kernel.utils.loader import UnstructuredPaddleImageLoader, UnstructuredPaddlePDFLoader, UnstructuredPaddleAudioLoader
from kernel.utils.splitter import zh_title_enhance
# from kernel.utils.loader.self_pdf_loader import PdfLoader
from kernel.utils.loader.markdown_parser import convert_markdown_to_langchaindoc
...
if not USE_FAST_PDF_PARSER and not os.path.islink(pdf_models_path):
    debug_logger.info(f'开始从modelscope上下载强力PDF解析相关模型: thing-pdf-parser')
    model_dir = snapshot_download('thing-pdf-parser')

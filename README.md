...
This repository contains the large language model fine-tuning dataset and core code implementation of the intelligent building code question answering framework introduced in the paper:

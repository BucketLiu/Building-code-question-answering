...
from data_parsing.magic_pdf.libs.commons import get_top_percent_list, mymax
from data_parsing.magic_pdf.libs.language import detect_lang
from data_parsing.magic_pdf.libs.pdf_check import detect_invalid_chars_by_pymupdf

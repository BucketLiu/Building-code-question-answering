...
from data_parsing.magic_pdf.config.enums import SupportedPdfParseMethod
from data_parsing.magic_pdf.config.ocr_content_type import BlockType, ContentType
from data_parsing.magic_pdf.data.dataset import Dataset, PageableData
from data_parsing.magic_pdf.libs.boxbase import calculate_overlap_area_in_bbox1_area_ratio
from data_parsing.magic_pdf.libs.clean_memory import clean_memory
from data_parsing.magic_pdf.libs.config_reader import get_local_layoutreader_model_dir
from data_parsing.magic_pdf.libs.convert_utils import dict_to_list
from data_parsing.magic_pdf.libs.hash_utils import compute_md5

from data_parsing.magic_pdf.libs.pdf_image_tools import cut_image_to_pil_image
from data_parsing.magic_pdf.model.magic_model import MagicModel
...
from data_parsing.magic_pdf.model.sub_modules.model_init import AtomModelSingleton
from data_parsing.magic_pdf.para.para_split_v3 import para_split
from data_parsing.magic_pdf.pre_proc.construct_page_dict import ocr_construct_page_component_v2
from data_parsing.magic_pdf.pre_proc.cut_image import ocr_cut_image_and_table
from data_parsing.magic_pdf.pre_proc.ocr_detect_all_bboxes import ocr_prepare_bboxes_for_layout_split_v2
from data_parsing.magic_pdf.pre_proc.ocr_dict_merge import fill_spans_in_blocks, fix_block_spans_v2, fix_discarded_block
from data_parsing.magic_pdf.pre_proc.ocr_span_list_modify import get_qa_need_list_v2, remove_overlaps_low_confidence_spans, remove_overlaps_min_spans
...
def do_predict(boxes: List[List[int]], model) -> List[int]:
    from data_parsing.magic_pdf.model.sub_modules.reading_oreder.layoutreader.helpers import (
...
def cal_block_index(fix_blocks, sorted_bboxes):
    ...
    if sorted_bboxes is not None:
        ...
        from data_parsing.magic_pdf.model.sub_modules.reading_oreder.layoutreader.xycut import \
            recursive_xy_cut

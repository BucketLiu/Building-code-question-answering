...
from data_parsing.magic_pdf.libs.config_reader import get_local_models_dir, get_device, get_table_recog_config, get_layout_config, \
    get_formula_config
from data_parsing.magic_pdf.model.model_list import MODEL
...
def custom_model_init(ocr: bool = False, show_log: bool = False, lang=None,
    ...
    if model_config.__use_inside_model__:
        ...
        if model == MODEL.Paddle:
            from data_parsing.magic_pdf.model.pp_structure_v2 import CustomPaddleModel
            custom_model = CustomPaddleModel(ocr=ocr, show_log=show_log, lang=lang)
        elif model == MODEL.PEK:
            from data_parsing.magic_pdf.model.pdf_extract_kit import CustomPEKModel

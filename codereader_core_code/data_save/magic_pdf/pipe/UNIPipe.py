...
from data_save.magic_pdf.model.doc_analyze_by_custom_model import doc_analyze
from data_save.magic_pdf.pipe.AbsPipe import AbsPipe
from data_save.magic_pdf.user_api import parse_ocr_pdf, parse_union_pdf
...
if __name__ == '__main__':
    # 测试
    from data_save.magic_pdf.data.data_reader_writer import DataReader

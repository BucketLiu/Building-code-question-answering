import fitz
from data_save.magic_pdf.config.constants import CROSS_PAGE
from data_save.magic_pdf.config.ocr_content_type import BlockType, CategoryId, ContentType
from data_save.magic_pdf.data.dataset import PymuDocDataset

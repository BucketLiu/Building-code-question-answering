...
class BasePredictor:
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks=None, save_dir=''):
        """
        ...
        # self.save_dir = increment_path(cfg.save_dir, exist_ok=self.args.exist_ok)
        self.save_dir = increment_path(save_dir, exist_ok=self.args.exist_ok)
        ...
        self.temporary_files = "temporary_files/layout/"
    ...
    def write_results(self, idx, results, batch):
        ...
        if self.args.save_crop:
            ...
            result.save_crop(save_dir=self.temporary_files + 'crops', file_name=self.data_path.stem)
        ...
        for batch in self.dataset:
            ...
            for i in range(n):
                ...
                if self.args.save and self.plotted_img is not None:
                    ...
                    self.save_preds(vid_cap, i, str(self.temporary_files + p.name))
